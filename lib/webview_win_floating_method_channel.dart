...
class MethodChannelWebviewWinFloating extends WebviewWinFloatingPlatform {
  ...
  Future<void> loadUrl(int webviewId, String url) async {
    await methodChannel.invokeMethod<bool>('loadUrl', {
      "webviewId": webviewId,
      "url": url,
    });
  }
  ...
  Future<void> setVisibility(int webviewId, bool isVisible) async {
    await methodChannel.invokeMethod<bool>('setVisibility', {
      "webviewId": webviewId,
      "isVisible": isVisible,
    });
  }
  ...
  Future<void> enableJavascript(int webviewId, bool isEnable) async {
    await methodChannel.invokeMethod<bool>('enableJavascript', {
      "webviewId": webviewId,
      "isEnable": isEnable,
    });
  }
  ...
  Future<bool> setUserAgent(int webviewId, String userAgent) async {
    bool? b = await methodChannel.invokeMethod<bool?>('setUserAgent', {
      "webviewId": webviewId,
      "userAgent": userAgent,
    });
    return b!;
  ...
  Future<bool> canGoBack(int webviewId) async {
    bool? b = await methodChannel.invokeMethod<bool?>('canGoBack', {
      "webviewId": webviewId,
    });
    return b!;
  }
  ...
  Future<bool> canGoForward(int webviewId) async {
    bool? b = await methodChannel.invokeMethod<bool?>('canGoForward', {
      "webviewId": webviewId,
    });
    return b!;
  }
  ...
  Future<void> goForward(int webviewId) async {
    await methodChannel.invokeMethod<void>('goForward', {
      "webviewId": webviewId,
    });
  }
  ...
  Future<void> cancelNavigate(int webviewId) async {
    await methodChannel.invokeMethod<void>('cancelNavigate', {
      "webviewId": webviewId,
    });
  }
  ...
  Future<bool> clearCookies(int webviewId) async {
    bool? b = await methodChannel.invokeMethod<bool?>('clearCookies', {
      "webviewId": webviewId,
    });
    return b!;
  }
  ...
  Future<void> requestFocus(int webviewId) async {
    await methodChannel.invokeMethod<void>('requestFocus', {
      "webviewId": webviewId,
    });
  }
  ...
  Future<void> openDevTools(int webviewId) {
    return methodChannel.invokeMethod<void>('openDevTools', {
      "webviewId": webviewId,
    });
  }
